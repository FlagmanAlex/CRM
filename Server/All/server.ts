...
import { documentRouter } from './src/vitaminka/importExcel/documentRoute'
...
app.use('/api/vitaminka/document', documentRouter)
app.use('/api/vitaminka/item', itemRouter)
app.use('/api/vitaminka/brand', brandRouter)
app.use('/api/vitaminka/group', groupRouter)
